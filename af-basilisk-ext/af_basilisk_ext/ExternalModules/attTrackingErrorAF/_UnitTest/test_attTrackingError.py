...
def test_attTrackingError():
    ...
    [testResults, testMessage] = subModuleTestFunction()
    assert testResults < 1, testMessage


def subModuleTestFunction():
    ...
    if not unitTestSupport.isArrayEqual(moduleOutput, trueVector, 3, accuracy):
        testFailCount += 1
        testMessages.append(
            "FAILED: " + module.ModelTag + " Module failed sigma_BR unit test\n"
        )
    ...
    if not unitTestSupport.isArrayEqual(moduleOutput, trueVector, 3, accuracy):
        testFailCount += 1
        testMessages.append(
            "FAILED: " + module.ModelTag + " Module failed omega_BR_B unit test\n"
        )
    ...
    if not unitTestSupport.isArrayEqual(moduleOutput, trueVector, 3, accuracy):
        testFailCount += 1
        testMessages.append(
            "FAILED: " + module.ModelTag + " Module failed omega_RN_N unit test\n"
        )
    ...
    if not unitTestSupport.isArrayEqual(moduleOutput, trueVector, 3, accuracy):
        testFailCount += 1
        testMessages.append(
            "FAILED: " + module.ModelTag + " Module failed domega_RN_B unit test\n"
        )
